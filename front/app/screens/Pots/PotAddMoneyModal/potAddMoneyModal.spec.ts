// potAddMoneyModal.spec.ts
import { mount } from '@vue/test-utils';
import { describe, it, expect, vi, beforeEach } from 'vitest';
import { ref } from 'vue';
import PotAddMoneyModal from './index.vue';
...
vi.mock('./usePotAddMoneyModal', () => ({
  usePotAddMoneyModal: vi.fn(() => composableState),
}));

const mountComponent = (props?: { modelValue?: boolean }) =>
  mount(PotAddMoneyModal, {
    props: {
      modelValue: true,
      pot: potMock.value,
      ...props,
...
describe('PotAddMoneyModal', () => {
  ...
  describe('Rendering', () => {
    ...
    it('Should render add money form', () => {
      const wrapper = mountComponent();
