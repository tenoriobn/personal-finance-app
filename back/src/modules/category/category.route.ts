...
categoryRoutes.get("/categories/used", (context) => categoryController.getUsedCategories(context));
categoryRoutes.get("/categories/available", (context) => categoryController.getAvailableCategories(context));
